...
def class_node(id, name, attrs, methods, x, y):
    ...
    # Header
    c = f'        <mxCell id="{id}" value="{escape_xml(name)}" style="swimlane;fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=30;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;html=1;" vertex="1" parent="1"><mxGeometry x="{x}" y="{y}" width="{w}" height="{total_h}" as="geometry" /></mxCell>\n'
    
    # Attributes
    attr_text = "&lt;br&gt;".join([f"+ {a}" for a in attrs])
    c += f'        <mxCell id="{id}_a" value="{attr_text}" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=1;" vertex="1" parent="{id}"><mxGeometry y="30" width="{w}" height="{h_attrs}" as="geometry" /></mxCell>\n'
    ...
    c += f'        <mxCell id="{id}_m" value="{meth_text}" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=1;" vertex="1" parent="{id}"><mxGeometry y="{38+h_attrs}" width="{w}" height="{h_methods}" as="geometry" /></mxCell>\n'
...
def generate_er_diagram():
    ...
    c += ent("admin", "Admin / Manager", 400, 550)
